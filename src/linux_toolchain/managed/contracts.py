...
from linux_toolchain.recipes import available_families, get_recipe
...
_COMPILER_BACKEND_FAMILY = available_families()[0]
MANAGED_COMPILER_BACKEND_VERSION = _COMPILER_BACKEND_FAMILY.builder_version
MANAGED_COMPILER_BACKEND_GCC = _COMPILER_BACKEND_FAMILY.gcc
