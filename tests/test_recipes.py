...
class RecipeCatalogTest(unittest.TestCase):
    ...
    def test_aarch64_starts_at_glibc_2_17(self) -> None:
        ...
        self.assertEqual(spec.target.triplet, "aarch64-unknown-linux-gnu")
        ...
        self.assertEqual(get_recipe("aarch64", "2.26").binutils, "2.43.1")
        self.assertEqual(get_recipe("x86_64", "2.19").binutils, "2.43.1")
